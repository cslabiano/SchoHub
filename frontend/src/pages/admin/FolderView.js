        ...
        <>
            ...
            <div className={styles.partition}>
                ...
                <div className={styles.container}>
                    <Link to={`/admin/${userID}/resources/CMSC/CMSC21`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
                    <Folders title={"CMSC 21"}/>
                    </Link>
                    <Link to={`/admin/${userID}/resources/CMSC/CMSC22`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
                    <Folders title={"CMSC 22"}/>
                    </Link>
                    <Link to={`/admin/${userID}/resources/CMSC/CMSC123`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
                    <Folders title={"CMSC 123"}/>
                    </Link>
                    <Link to={`/admin/${userID}/resources/CMSC/CMSC130`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
                    <Folders title={"CMSC 130"}/>
                    </Link>
                    <Link to={`/admin/${userID}/resources/CMSC/CMSC150`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
    ...
    return (
        <>
            ...
            <div className={styles.partition}>
                ...
                <div className={styles.container}>
                    <Link to={`/admin/${userID}/resources/MATH/MATH27`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
                    <Folders title={"MATH 27"}/>
                
                    </Link>
                    <Link to={`/admin/${userID}/resources/MATH/MATH28`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
                    <Folders title={"MATH 28"}/>
                    </Link>
                    <Link to={`/admin/${userID}/resources/MATH/MATH10`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
    ...
    return (
        <>
            ...
            <div className={styles.partition}>
                ...
                <div className={styles.container}>
                    <Link to={`/admin/${userID}/resources/STAT/STAT101`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
    ...
    return (
        <>
            ...
            <div className={styles.partition}>
                ...
                <div className={styles.container}>
                    <Link to={`/admin/${userID}/resources/OTHERS/ETHICS1`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
                    <Folders title={"ETHICS 1"}/>
                    </Link>
                    <Link to={`/admin/${userID}/resources/OTHERS/KAS1`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
                    <Folders title={"KAS 1"}/>
                    </Link>
                    <Link to={`/admin/${userID}/resources/OTHERS/HIST1`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
                    <Folders title={"HIST 1"}/>
                    </Link>
                    <Link to={`/admin/${userID}/resources/OTHERS/COMM10`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
                    <Folders title={"COMM 10"}/>
                    </Link>
                    <Link to={`/admin/${userID}/resources/OTHERS/PI10`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
                    <Folders title={"PI 10"}/>
                    </Link>
                    <Link to={`/admin/${userID}/resources/OTHERS/ARTS1`} style={{ color: 'inherit', textDecoration: 'inherit' }}>
